<?php
    ...
    require('conexao.php');// Não sei se é aqui que tem que dar require ou em outro lugar, dequalquer forma logo não vai mais precisar
    class Usuario{
        protected $id;
        protected $nome;
        protected $email;
    ...
    // Eu vou deixar essas partes aqui para >VOCÊ< Daniel Dwulatka resolver se já tá bom ou se faltou algo nos models
