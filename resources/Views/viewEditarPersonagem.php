            ...
            <form method="POST">
                ...
                <div class="columns">
                    ...
                    <div class="column">
                        ...
                        <input
                            class="input"
                            name="nome"
                            value="<?= $personagemSelecionado['nome'] ?>"
                        >
                    ...
                    <div class="column">
                        ...
                        <input
                            class="input"
                            name="level"
                            value="<?= $personagemSelecionado['level'] ?>"
                        >
                ...
                <div class="columns">
                    ...
                    <div class="column">
                        ...
                        <input
                            class="input"
                            name="subclasse"
                            value="<?= $personagemSelecionado['subclasse'] ?>"
                        >
                    ...
                    ?>
                        ...
                        <div class="column is-2">
                            ...
                            <input
                                class="input"
                                name="<?= $key ?>"
                                value="<?= $personagemSelecionado[$key] ?>"
                            >
                ...
                <div class="columns">
                    ...
                    <div class="column">
                        ...
                        <input
                            class="input"
                            name="vida"
                            value="<?= $personagemSelecionado['vida'] ?>"
                        >
                    ...
                    <div class="column">
                        ...
                        <input
                            class="input"
                            name="armadura"
                            value="<?= $personagemSelecionado['armadura'] ?>"
                        >
                    ...
                    <div class="column">
                        ...
                        <input
                            class="input"
                            name="velocidade"
                            value="<?= $personagemSelecionado['velocidade'] ?>"
                        >
                ...
                <div class="content">
                    ...
                    <textarea
                        class="textarea"
                        name="historia"
                    ><?= $personagemSelecionado['historia'] ?></textarea>
