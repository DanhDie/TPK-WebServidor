        ...
        <div class="box">
            ...
            <div class="container">
                    ...
                    <div class="column is-8">
                            ...
                            <div class="columns is-multiline">
                                ...
                                <div class="column is-4">
                                    ...
                                    <p>
                                        ...
                                        <?= $personagemSelecionado['subclasse'] ?>
                        ...
                        <div class="columns is-multiline">
                            ...
                            foreach ($atributos as $sigla => $key):
                                ...
                                $mod = Personagem::statCalculator(
                                    (int)$personagemSelecionado[$key]
                                );
                            ...
                            <div class="column">
                                ...
                                <div class="box has-text-centered">
                                    ...
                                    <h1 class="is-size-3 has-text-primary has-text-weight-bold">
                                        ...
                                        <?= $personagemSelecionado['armadura'] ?>
                            ...
                            <div class="column">
                                ...
                                <div class="box has-text-centered">
                                    ...
                                    <h1 class="is-size-3 has-text-primary has-text-weight-bold">
                                        ...
                                        <?= $personagemSelecionado['velocidade'] ?>
                ...
                <a
                    ...
                    href="<?= BASE_URL ?>/editarPersonagem?idP=<?= $personagemSelecionado['id'] ?>"
                >
